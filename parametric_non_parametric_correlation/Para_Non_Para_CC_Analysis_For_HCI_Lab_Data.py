...
root_data_path = r'C:\Users\HP\Desktop\5th & 6th Semester\Bap Re Bap\HCI Lab Data Sets\dataset_web\participant_10.csv'
...
def find_the_correlation(variable_1_data):
    ...
    corr_coef_writer = open("C:\\Users\\HP\\Desktop\\5th & 6th Semester\\Bap Re Bap\\Results\\Results - txt Files\\HCI Lab - Germany\\Seconds\\TESTSS_"+file_name+"__sec.txt", "a")
...
def get_data(dataset_60_130):
    ...
    acceleration_x.append(columns_name[1])
    acceleration_y.append(columns_name[2])
    acceleration_z.append(columns_name[3])
    ...
    for line in dataset_60_130[2:]:
        ...
        if current_time_accel == prev_time_accel:
            ...
            acceleration_x.append(sum_accel_x / n_value)
            acceleration_y.append(sum_accel_y / n_value)
            acceleration_z.append(sum_accel_z / n_value)
    ...
    return time_id_list, acceleration_x, acceleration_y, acceleration_z, heart_rate
        ...
        if check_by_seconds:
            ...
            for line in data[1:]:
                ...
                if 60 <= HR <= 130:
                    ...
                    dataset_60_to_130.append(single_line_data)
                    single_line_data = []
            time_id_list, acceleration_x, acceleration_y, acceleration_z, heart_rate = get_data(dataset_60_to_130)
...
# Testing.............................Checking.............................................
        ...
        data_writer = open("C:\\Users\\HP\\Desktop\\5th & 6th Semester\\Bap Re Bap\\Results\\Data_HCI_Lab\\Seconds\\Tesstttts_"+os.path.basename(root_data_path)+"__Sec.txt",
                                "w")
        # for (time_id, x, y, z, pulse) in zip(time_id_list, acceleration_x, acceleration_y, acceleration_z, heart_rate):
        #     str_data_write = str(time_id)+","+str(x) + ","+ str(y) + "," + str(z) + "," + str(pulse)
